...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hospitalmanagmentsoftware/two arrow.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hospitalmanagmentsoftware/add new patient.png"))); // NOI18N
        jButton2.setText("Add New Pateint Record");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        int a = JOptionPane.showConfirmDialog(null, "Do Youo Really Want To Logout", "select", JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
            setVisible(false);
